...
class Template
{
   ...
   function admin($template, $data_content = array())
   {
      ...
      $data_content['profil']  = $this->ci->admin->get_all('tbl_profil_toko');
   ...
   function olshop($template, $data_content = array())
   {
      ...
      $data_content['profil'] 	= $this->ci->app->get_all('tbl_profil_toko');
      $data_content['kategori']  = $this->ci->app->get_all('tbl_kategori');
      $data['content']           = $this->ci->load->view($template, $data_content, TRUE);
