...
<div class="form-w3layouts">
   ...
   <div class="table-agile-info">
      <h2>Laporan Order Per Bulan</h2><br>
   ...
   <div class="x_content">
      <div class="row">
         ...
         <div class="col-md-10 col-sm-12">
            <h3>Laporan Bulan <?=$Bulan;?> Tahun <?=$thn;?></h3><br>
         </div>
         <div class="col-md-1 col-sm-12 col-md-offset-1">
            <a href="<?= site_url('transaksi/cetak/'.$bln.'/'.$thn); ?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i></a>
         </div><br>
