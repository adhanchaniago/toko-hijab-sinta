      ...
      <form class="form-horizontal form-label-left" action="" method="post">
         <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-12">
               <input type="text" class="form-control" name="username_admin" value="<?= $username_admin; ?>">
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-12">
               <input type="email" class="form-control col-md-7 col-xs-12" name="email_admin" value="<?= $email_admin; ?>">
            </div>
         </div>
