...
<br />
<div class="row">
   <table class="table table-responsive col m12 s12">
      <thead>
         <tr>
      ...
      <tbody>
         ...
         ?>
            ...
            <tr>
               ...
               <td style="text-align:center;">Rp. <?= number_format($key->total, 0, ',', '.') ?>,-</td>
               <td class="center">
                  <?php
               ...
               <td class="center">
                  <a href="<?=site_url('home/detail_transaksi/'.$key->id_order)?>" class="btn btn-floating green">Detail</a>

                  <?php
                  if ($key->status_proses != 'proses' && $key->status_proses != 'selesai') {
                  ?>
                     <a href="<?=site_url('home/hapus_transaksi/'.$key->id_order);?>" class="btn btn-warning" onclick="return confirm('Yakin ingin menghapus data ini ?')">
                        hapus
                     </a>
                  <?php
                  }
                  ...
                  ?>
                     <a href="<?=site_url('home/transaksi_selesai/'.$key->id_order);?>" class="btn btn-primary">selesai</a>
                  <?php
                  }
                  ?>
               </td>
