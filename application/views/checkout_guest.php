                   ...
                   <?= validation_errors('<p style="color:red">', '</p>'); ?>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Nama Depan" value="" name="first_name" id="first_name">
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Nama Belakang" value="" id="last_name" name="last_name">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              <label>Email</label>
                              <input type="email" id="user_mail" name="user_mail" class="form-control" placeholder="Email" value="">
                           </div>
                        </div>
