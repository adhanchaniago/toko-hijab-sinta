...
class Transaksi extends CI_Controller {
   ...
   public function konfirmasi()
   {
      ...
      $table = "tbl_order o
		...
		if ($this->email->send())
		{
			$this->trans->update('tbl_order', ['status_proses' => 'proses'], ['id_order' => $this->uri->segment(3)]);
   ...
   public function delete()
   {
      ...
      $this->trans->delete(['tbl_order', 'tbl_detail_order'], ['id_order' => $this->uri->segment(3)]);
